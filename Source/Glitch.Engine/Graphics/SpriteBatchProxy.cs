...
namespace Glitch.Engine.Graphics
{
    /// <summary>
    ...
    public class SpriteBatchProxy
    {
        ...
        {
            _spriteBatch.Draw(GlitchApplication.MagicContentManager.EmptyTexture, rect, color);
        }
        ...
        /// </summary>
        public void Begin(Camera2D camera, Vector2 parallax)
        {
