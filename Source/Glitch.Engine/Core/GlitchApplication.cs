...
using Glitch.Engine.Script;
using Glitch.Engine.Util;
using Glitch.Engine.Utils;
...
namespace Glitch.Engine.Core
{
    ...
    /// </summary>
    public abstract class GlitchApplication : Game
    {
        protected static GlitchApplication Instance;
        ...
        /// Constructor
        /// </summary>
        protected GlitchApplication(string name, string rootContentDirectory, string version)
        {
