...
namespace Glitch.Engine.Core
{
    ...
    public static class Resolution
    {
        ...
        private static void ApplyChanges()
        {
            ...
            {
                if ((DeviceWidth != _graphics.PreferredBackBufferWidth) && (DeviceHeight != _graphics.PreferredBackBufferHeight))
                {
        ...
        private static void CalculateViewport()
        {
            ...
            //// nondidju ! On va pas se limiter � un title safe area calibr� sans bandes noires ! Let's correct this sh*t. 
