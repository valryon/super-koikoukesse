...
namespace Glitch.Engine.Particules
{
    ...
    public abstract class Particule
    {
        ...
        {
            spriteBatch.Draw(GlitchApplication.MagicContentManager.GetTexture("particules"), Location, src, color * alpha, rotation, particuleOrigin, scale, SpriteEffects.None, 1.0f);
        }
